...
<section id='mainvisual'>
    <div class='mv-bg'>
        <img src="{{ asset('images/mv_bg_sp.jpg')}}" alt="ハウスmuch?" class='js-image-switch'>
    </div>
    <div class='icon'>
        <img src="{{ asset('images/mv_icon.png') }}" alt="ハウスmuch?">
    </div>
    <div class='text'>
        <p>私たちは時間がいつも同じように流れることを信じて疑いません。<br>時間は常に同じ速さで未来へ向かって流れ続け、<br>場所によって変わったり、<br>季節によって変わったりすることなどあり得ないと思っています。</p>
    </div>
</section>
